...
interface ContactDao {
    ...
    @Query("SELECT * FROM ContactDbModel WHERE id IN (:noteIds)")
    fun getNotesByIdsSync(noteIds: List<Long>): List<ContactDbModel>
    ...
    @Query("DELETE FROM ContactDbModel WHERE id IN (:noteIds)")
